...
class MessagesNotifier extends StateNotifier<List<types.Message>> {
  ...
  final prompt = "以上のようなエイサー祭りがあります。\n"
               ...
               "あなたは5回質問をした後に、答えと思われるものを答えてください。\n"
              //  "あなたの出力回数は質問５回と回答の合計６回です\n"
               "また、ルールとして以下を設けます。\n"
               "・質問をまとめて生成するのは禁止です。\n"
               "・「はい」か「いいえ」で答えられる質問にしてください。\n"
               "・祭りの名前を出すのは禁止です。\n"
               "・このエイサー祭りの開催時間はイギリス時間なので日本時間に直して考えてください。\n"
               "・質問する際は｛されますか？｝ではなく｛されるものがいいですか？｝にしてください。\n"
               "・質問をする際はQ+質問番号+質問文のみを出力してください。\n"
               "・質問に対する回答にありがとうございますなどは出力しないでください。\n"
               "・エイサー以外の伝統芸能を聞きたいときはエイサーが含まれていないことを明示してください。\n"
               "・日付を直接聞くのは禁止です。\n"
               "・1回あたり1つの質問を出力してください。\n"
               "・結果はIDと名前で出力してください\n"
               "・質問は５回行ってください";
